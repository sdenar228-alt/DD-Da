...
protected:
	...
	// Only OpenGL 3.3 can use a user supplied shader, older versions ignore it.
	virtual void Cmd_SetCustomShader(const CCommandBuffer::SCommand_SetCustomShader *pCommand) {}
